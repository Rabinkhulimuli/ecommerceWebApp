    ...
    <Card>
      <CardContent className='p-4 sm:p-6'>
        <div className='flex items-center justify-around gap-1 sm:gap-4'>
          ...
          <div className='flex flex-col items-start space-y-4 sm:flex-row sm:items-center sm:gap-4 sm:space-y-0 lg:flex-col xl:flex-row'>
            <div onClick={() => router.push(`/products/${item.product.id}`)} className=''>
              ...
              <p className='mt-1 hidden text-sm font-bold text-gray-900 sm:block md:hidden'>
            ...
            <div className='flex w-full flex-col justify-between gap-2 space-y-2 sm:flex-row sm:items-center sm:justify-around sm:gap-2 sm:space-y-0'>
              ...
              <div className='flex items-center justify-between text-right'>
                <p className='block font-bold sm:hidden sm:text-lg md:block'>
