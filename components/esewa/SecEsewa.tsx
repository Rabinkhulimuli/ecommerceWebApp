...
const PaymentForm = ({ total_amount }: { total_amount: number }) => {
  ...
  return (
    <form action='https://rc-epay.esewa.com.np/api/epay/main/v2/form' method='POST'>
      ...
      <input type='hidden' name='success_url' value='https://your-success-url.com/' required />
      <input type='hidden' name='failure_url' value='https://your-failure-url.com/' required />
      <input
        type='hidden'
