  ...
  return (
    <div className='w-full'>
      ...
      <div className='group relative overflow-hidden rounded-2xl border border-emerald-200 bg-white p-4 shadow-sm transition-all hover:shadow-md'>
        ...
        <div className='mb-3 flex flex-col justify-between sm:flex-row sm:items-center'>
          <div className='flex items-center gap-2'>
            ...
            <div>
              ...
              <p className='-mt-0.5 text-base font-semibold tracking-tight text-emerald-700'>
                eSewa
              </p>
            </div>
          </div>
        ...
        <div className='mt-3 flex flex-col items-center justify-between text-xs text-gray-500 sm:flex-row'>
