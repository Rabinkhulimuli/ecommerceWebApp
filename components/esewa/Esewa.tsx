...
// React Component
const Esewa: React.FC<PaymentFormProps> = ({ total_amount = 100 }) => {
  ...
  return (
    ...
    >
      ...
      <input type="hidden" name="total_amount" value={total_amount.toString()} required />
      <input
        type="hidden"
      ...
      <input type="hidden" name="product_service_charge" value="10" required />
      <input type="hidden" name="product_delivery_charge" value="10" required />
      <input
        type="hidden"
        name="success_url"
