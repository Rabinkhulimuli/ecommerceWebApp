    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        <div  className="space-y-3">
          {items.map((item) => (
            <div onClick={()=> router.push(`/products/${item.product.id}`)} key={item.id} className="flex items-center space-x-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium truncate max-w-32 md:max-w-xs">{item.product.name}</p>
