  ...
  return (
    <Card className="group product-card-hover overflow-hidden">
      ...
      <CardContent className="p-4">
        ...
        <div className="flex items-center justify-between mt-3">
          ...
          <div className="flex items-center space-x-1">
            <div className="flex text-yellow-400">{"★".repeat(Math.floor(product.rating || 5))}</div>
      ...
      <CardFooter className="p-4 pt-0">
        <Button onClick={handleAddToCart} className="w-full group" disabled={!product.inStock}>
