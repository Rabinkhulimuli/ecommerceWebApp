    ...
    <main className="min-h-screen">
        ...
        <div className="grid gap-8 md:grid-cols-2 md:gap-12">
          <div>
            ...
            <p className="mt-3 text-muted-foreground">
              We started Acme Store after countless frustrating experiences with flimsy, over-priced goods.
              We believed there was a better way — products made to last, priced fairly, and shipped fast.
            </p>
            <p className="mt-3 text-muted-foreground">
              Today, our small but mighty team designs with intention, iterates with customer feedback,
              and partners with responsible manufacturers to bring ideas to life.
            </p>
          </div>
          <div>
            <h2 className="text-xl md:text-2xl font-semibold">Our mission</h2>
            <p className="mt-3 text-muted-foreground">
              To elevate everyday living through thoughtful design, exceptional service, and sustainable choices —
              without compromising on value.
            </p>
            <ul className="mt-4 space-y-3">
              <li className="flex items-start gap-3">
                <Package className="h-5 w-5 mt-0.5 text-muted-foreground" aria-hidden="true" />
                <p className="text-sm">
              ...
              <li className="flex items-start gap-3">
                ...
                <p className="text-sm">
                  Global fulfillment network for fast, reliable delivery.
                </p>
              </li>
              <li className="flex items-start gap-3">
                <Leaf className="h-5 w-5 mt-0.5 text-muted-foreground" aria-hidden="true" />
                <p className="text-sm">
      ...
      <section className="mx-auto max-w-6xl px-4 md:px-6 py-12 md:py-16">
        <div className="flex items-center justify-between gap-4">
          <h2 className="text-xl md:text-2xl font-semibold">What we value</h2>
          <Badge variant="outline" className="hidden md:inline-flex">Company values</Badge>
        </div>
      ...
      <section className="mx-auto max-w-6xl px-4 md:px-6 py-12 md:py-16">
        <div className="flex items-center justify-between gap-4">
          ...
          <Badge variant="outline" className="hidden md:inline-flex">People behind Acme</Badge>
        </div>
        <p className="mt-3 text-muted-foreground">
          We&apos;re a distributed crew of builders, designers, and support pros united by customer happiness.
        </p>
      ...
      <section className="mx-auto max-w-6xl px-4 md:px-6 py-12 md:py-16">
        <div className="grid gap-8 md:grid-cols-12">
          ...
          <div className="md:col-span-7">
            <h2 className="text-xl md:text-2xl font-semibold">Sustainability & impact</h2>
            <p className="mt-3 text-muted-foreground">
              We design for longevity and ship with recycled or recyclable materials wherever possible.
              Our operations team continuously evaluates suppliers to improve energy and material efficiency.
            </p>
      ...
      <section className="mx-auto max-w-6xl px-4 md:px-6 py-12 md:py-16">
        <div className="text-center">
          <h2 className="text-xl md:text-2xl font-semibold">As seen in</h2>
          <p className="mt-3 text-muted-foreground">
        ...
        <Card className="overflow-hidden">
          <div className="grid md:grid-cols-2">
            <div className="p-6 md:p-8">
              <h3 className="text-lg md:text-xl font-semibold">Ready to discover your next favorite thing?</h3>
