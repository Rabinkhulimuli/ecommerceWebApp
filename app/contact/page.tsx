          ...
          <div className="mt-6 grid gap-8 md:grid-cols-12 md:gap-12">
            ...
            <div className="md:col-span-7">
              ...
              <p className="mt-4 text-muted-foreground text-base md:text-lg">
                Questions about an order, product recommendations, or returns? Send us a message and our team will get back to you shortly.
              </p>
              <div className="mt-6">
                <ContactForm />
              </div>
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Mon–Fri, 9am–5pm (Local time)</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">123 Commerce St, Suite 100, Your City</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
