...
const profileSchema = z.object({
  ...
  addresses: z.array(addressSchema).min(1, 'At least one address is required').max(2),
    ...
    <div className='mx-auto max-w-3xl p-4 md:p-8'>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className='space-y-6'>
        ...
        <div className='flex flex-col items-center gap-4'>
          <div
            className='group relative h-28 w-28 cursor-pointer overflow-hidden rounded-full border'
        ...
        <div className='space-y-4'>
              ...
              >
                ...
                <div className='space-y-3'>
                  <div>
                    ...
                    <Input id={`street-${index}`} {...register(`addresses.${index}.street`)} />
                  ...
                  <div>
                    ...
                    <Input id={`city-${index}`} {...register(`addresses.${index}.city`)} />
                  ...
                  <div>
                    ...
                    <Input id={`country-${index}`} {...register(`addresses.${index}.country`)} />
          ...
          {errors.addresses?.root && (
            <p className='text-sm text-red-500'>{errors.addresses.root.message}</p>
          )}
        </div>

        {/* Submit Button */}
        <div className='flex justify-end pt-4'>
          <Button type='submit' disabled={loading || !isDirty} className='min-w-32'>
            {loading ? (
